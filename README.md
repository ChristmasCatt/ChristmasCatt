...
<svg xmlns="http://www.w3.org/2000/svg" width="495" height="195" viewBox="0 0 495 195" fill="none" role="img" aria-labelledby="descId">
        <title id="titleId">FloppaDaddy's GitHub Stats, Rank: A+</title>
        <desc id="descId">Total Stars Earned: 3, Total Commits in 2022 : 3, Total PRs: 0, Total Issues: 0, Contributed to: 0</desc>
        <style>
          .header {
    ...
    @keyframes fadeInAnimation {
      ...
      <text x="0" y="0" class="header" data-testid="header">FloppaDaddy's GitHub Stats</text>
    </g>
      </g>
    ...
    <g class="stagger" style="animation-delay: 450ms" transform="translate(25, 0)">
      ...
      <text class="stat  bold" x="170" y="12.5" data-testid="stars">3</text>
    </g>
  </g><g transform="translate(0, 25)">
    <g class="stagger" style="animation-delay: 600ms" transform="translate(25, 0)">
      
      <text class="stat  bold" y="12.5">Total Commits (2022):</text>
      <text class="stat  bold" x="170" y="12.5" data-testid="commits">52</text>
    </g>
  </g><g transform="translate(0, 50)">
    <g class="stagger" style="animation-delay: 750ms" transform="translate(25, 0)">
      
      <text class="stat  bold" y="12.5">Total PRs:</text>
      <text class="stat  bold" x="170" y="12.5" data-testid="prs">0</text>
    </g>
  </g><g transform="translate(0, 75)">
    <g class="stagger" style="animation-delay: 900ms" transform="translate(25, 0)">
      
      <text class="stat  bold" y="12.5">Total Issues:</text>
      <text class="stat  bold" x="170" y="12.5" data-testid="issues">0</text>
    </g>
  </g><g transform="translate(0, 100)">
    <g class="stagger" style="animation-delay: 1050ms" transform="translate(25, 0)">
      
      <text class="stat  bold" y="12.5">Contributed to:</text>
      <text class="stat  bold" x="170" y="12.5" data-testid="contribs">0</text>
    </g>
  </g>
    </svg>
